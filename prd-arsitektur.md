...
**Versi:** 1.6 — 23 September 2026 (v1.5 + Plan 5: frontend React `equinox-dashboard/` di atas data layer `web/src` yang sama — enam halaman, tata letak ponsel, 152 test; seluruh 12 butir penerimaan `docs/FRONTEND_BRIEF.md` §9 lulus terhadap chain live 22 Sep 2026, lalu GitHub Pages beralih ke aplikasi ini dengan UI klasik sebagai cadangan; §10.4)

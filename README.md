...
| Pool C on real USDG (Plan 4) | ✅ 20 Sep 2026 13:57 UTC — created through the existing factory (tx `0xedcfbd1f…53fb`, 4,976,404 gas, block 310891153), seeded with 100 USDG from the Paxos faucet, one round-trip trade settled in real USDG (`buy` 0.01 C 2600 board 1 `0x3ae0a152…4ffc`, `close` `0xd937a992…ffff`); scale is hundreds of USDG (faucet cap), not the main demo — see "Live on Arbitrum Sepolia" |
...
| `prd-arsitektur.md` | PRD & technical architecture v1.5 (Indonesian; Plans 3 and 4 as built) |

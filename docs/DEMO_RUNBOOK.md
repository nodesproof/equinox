...
- [ ] 4. Explorer: the address links in the README resolve; **decide** on source verification (`RUBRIC_SCORECARD.md` rank 3: `forge verify-contract` for the 12 Solidity contracts + `cargo stylus verify`) — today every link shows bytecode only.
